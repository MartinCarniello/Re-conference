Feature: Como usuario quiero poder dejar un comentario en una propuesta
	...
	Scenario: Se registra un usuario orador, se loguea en el sistema y se crea una propuesta
		...
		And seteo el titulo de la propuesta "RubyConfTestComentariosPropuesta1"
	...
	Scenario: El evaluador deja un comentario
		...
		And clickeo en comentar
		Then me deberia redirigir al detalle de la propuesta donde deberia estar el comentario Comentario1TestComentarios creado